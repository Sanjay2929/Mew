        ...
        <Container className="my-5 pb-sm-5 container">
          <Row>
            <Col lg={5} data-aos="fade-down-right">
              <p className="ff_Slackey fw_400 fs_45 cl_292525 mb-4 text-lg-start text-center">
                DaCode Blog
              </p>
              <p className="ff_Poppins fw_400 fs_16 cl_65668 maxw_362 text-lg-start text-center">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
                enim ad minim velit esse cillum dolore eu fugiat nulla pariatur.
              </p>
              <div className="pt-lg-5 pt-3 mt-1 d-flex justify-content-lg-start justify-content-center">
            ...
            <Col lg={7} data-aos="fade-down-left">
              <Slider
                {...settings}
                ref={first}
                className="slider_shadow saasbusines mt-lg-0 mt-5"
              >
                <div className="d-sm-flex gap-3 gap-xl-5 px-2 ">
                  ...
                  <div className="pt-3 pt-sm-1">
                    <p className="ff_Poppins fw_600 fs_20 cl_292525">
                      Why Your SaaS Business should use WordPress
                    </p>
                    <p className="ff_Poppins fw_400 fs_16 cl_65668 opacity5 pb-3">
                    ...
                    <div className="d-flex gap-3 pt-xl-4 pb-2">
                      ...
                      >
                        ...
                        >
                          <path
                            d="M12.9467 7.88379L2.82078 7.88379"
                            stroke="white"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          ...
                          />
                          <path
                            d="M6.9632 12.0261L2.82075 7.88368L6.9632 3.74124"
                            stroke="white"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                      ...
                      >
                        ...
                        >
                          <path
                            d="M2.82071 7.88379L12.9467 7.88379"
                            stroke="white"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                          <path
                            d="M8.80426 3.74146L12.9467 7.8839L8.80426 12.0263"
                            stroke="white"
                            strokeWidth="1.5"
                            strokeLinecap="round"
