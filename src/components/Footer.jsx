...
const Footer = () => {
  return (
    <>
      <section className="bg_FFF4EA pt-5">
        <Container className="container">
          <Row className="pb-5 pt-lg-5">
            <Col sm={12} lg={6} data-aos="fade-left" data-aos-delay="200">
              <p className="ff_Slackey fw_400 fs_27 mb-0 pb-lg-4">Mew</p>
              <p className="ff_Poppins fw_400 fs_16 cl_gray maxw_446 pt-1 pb-lg-4 lh_30">
            ...
            <Col sm={12} lg={6}>
              <Row>
                <Col
                  ...
                  data-aos-delay="400"
                >
                  <p className="ff_Slackey fw_400 fs_18 cl_lightgray mb-md-5 mb-2">
                    Useful links
                  </p>
                  <a href="" className="ff_Poppins fw_400 fs_14 cl_gray lh_38 hover_black">
                    FAQs
                  </a>
                  <a href="" className="ff_Poppins fw_400 fs_14 cl_gray lh_38 hover_black">
                    {" "}
          ...
          <div className="footerline mt-1 mb-4"></div>
          <p className="mt-1 mb-0 ff_Poppins fw_400 fs_16 cl_blacklight opacity5 text-center pb-4">
